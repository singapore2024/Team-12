...
export default function CommunityPage() {
  ...
  return (
    <div className="w-full flex bg-white h-[calc(100vh-64px)]">
      ...
      <div className="w-4/5 p-5 overflow-y-auto text-black">
        {thread === -1 ? (
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-xl font-bold leading-loose mt-6 mb-4">
              Comments
            </h2>
